    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-7.5">
        <div className="rounded-[10px] border border-stroke bg-white p-6 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
          <h4 className="text-title-sm font-bold text-dark dark:text-white">12</h4>
          <span className="text-body-sm font-medium">Total Recruiters</span>
        </div>
        <div className="rounded-[10px] border border-stroke bg-white p-6 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
          <h4 className="text-title-sm font-bold text-dark dark:text-white">142</h4>
          <span className="text-body-sm font-medium">Total Jobs Created</span>
        </div>
        <div className="rounded-[10px] border border-stroke bg-white p-6 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card">
          <h4 className="text-title-sm font-bold text-dark dark:text-white">5,234</h4>
      ...
      <div className="mt-8 rounded-[10px] bg-white shadow-1 dark:bg-gray-dark dark:shadow-card">
        ...
        <div className="grid grid-cols-4 border-t border-stroke px-4 py-4.5 dark:border-dark-3 md:px-6 2xl:px-7.5">
          ...
          <div className="col-span-1 flex items-center"><p className="font-medium text-dark dark:text-dark-6">Jobs Managed</p></div>
          <div className="col-span-1 flex items-center justify-end"><p className="font-medium text-dark dark:text-dark-6">Actions</p></div>
        </div>

        {[
          { name: "John Doe", email: "john@hiremind.ai", jobs: 15 },
          { name: "Jane Smith", email: "jane@hiremind.ai", jobs: 8 },
        ].map((recruiter, key) => (
          <div className="grid grid-cols-4 border-t border-stroke px-4 py-4.5 dark:border-dark-3 md:px-6 2xl:px-7.5" key={key}>
            ...
            <div className="col-span-1 flex items-center"><p className="text-body-sm text-dark dark:text-dark-6">{recruiter.jobs}</p></div>
