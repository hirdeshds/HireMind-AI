  ...
  return (
    ...
    >
      ...
      <div className={`relative z-10 flex flex-col items-center gap-4 transition-transform duration-500 ${hovered ? "-translate-y-2" : ""}`}>
        <div className="flex items-center gap-3 rounded-lg border border-white/20 bg-white/10 p-3 shadow-lg backdrop-blur-md">
          ...
          <div>
            <p className="text-sm font-semibold text-white">Smart Parsing</p>
            <p className="text-xs text-white/70">100+ Resumes Processed</p>
          </div>
        </div>

        <div className={`flex items-center gap-3 rounded-lg border border-white/20 bg-white/10 p-3 shadow-lg backdrop-blur-md transition-all duration-700 ${hovered ? "translate-x-4" : "-translate-x-4"}`}>
          ...
          <div>
            <p className="text-sm font-semibold text-white">AI Match Score</p>
            <p className="text-xs text-white/70">92% Average Match</p>
          </div>
        </div>
      </div>
    </div>
